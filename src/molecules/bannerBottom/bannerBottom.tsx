...
import { faAddressBook, faCloudArrowDown, faMoon, faSun } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="o-banner-bottom">
            ...
            <motion.div animate={{ opacity: 1, y: 0 }}
                ...
                transition={{ duration: duration, delay: delay }}>
                <Text
                    children="Software Engineer and a new IT graduate , having a strong foundation on the fundamentals of web development and apassion for creating user-friendly web-application"
            ...
            <div
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.4 }}
                    >
                        <FontAwesomeIcon icon={faCloudArrowDown} onClick={() => window.open("https://drive.google.com/drive/folders/1CODlhXRk_pABuC-jRppnrRqFiq8ECUBu?usp=sharing", "_blank")} />
                    </motion.div>
